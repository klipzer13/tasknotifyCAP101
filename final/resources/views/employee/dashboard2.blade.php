...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="dashboard-container">
                        ...
                        <div class="task-item">
                            ...
                            <div class="task-info">
                                ...
                                <div class="task-meta">
                                    ...
                                    <span
                                        class="status-badge status-{{ str_replace(' ', '-', strtolower($task->status->name)) }}">
                                        {{ $task->status->name }}
                                    </span>
                                </div>
                            </div>
                    ...
                    @empty
                        <div class="alert alert-info">No pending approvals at this time.</div>
                    @endforelse
            ...
            <div class="col-lg-6">
                <div class="dashboard-container">
                    ...
                    @forelse($recentActivity as $task)
                        <div class="task-item">
                            <div class="task-check">
                                <img src="{{ $task->creator->avatar_url ?? asset('images/default-avatar.png') }}"
                                    alt="{{ $task->creator->name }}" class="assignee">
                            </div>
                            <div class="task-info">
        ...
        <div class="dashboard-container mt-4">
                ...
                <div class="task-item {{ strtolower($task->priority->name) }}-priority">
                    ...
                    <div class="task-info">
                        ...
                        <div class="task-meta">
                            ...
                            <span><i class="fas fa-calendar-alt"></i> Due: {{ $task->due_date->diffForHumans() }}</span>
                            <span class="status-badge status-{{ str_replace(' ', '-', strtolower($task->status->name)) }}">
                                {{ $task->status->name }}
                            </span>
                        </div>
                    </div>
            ...
            @empty
                <div class="alert alert-info">No upcoming deadlines in the next week.</div>
            @endforelse
